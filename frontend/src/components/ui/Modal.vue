...
const props = defineProps({
  ...
  title: { type: String, default: localized("f56c6c82203b33f6", "Notice").toString() },
  content: { type: String, default: "" },
  confirmText: { type: String, default: localized("fac2a67ad87807c4", "OK").toString() },
  cancelText: { type: String, default: localized("2cd0f3be8738a86c", "Cancel").toString() },
